        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              <!-- 产品属性选择 -->
              <div class="choosed" v-for="(spuSaleAttr, index) in spuSaleAttrList" :key="spuSaleAttr.id"></div>
              <dl>
                <dt class="title">颜色</dt>
                <dd changepirce="0" :class="{ active: this.changeActive1 }" @click="changeActive11">金色</dd>
                <dd changepirce="40" :class="{ active: this.changeActive2 }" @click="changeActive22">银色</dd>
                <dd changepirce="90" :class="{ active: this.changeActive3 }" @click="changeActive33">黑色</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
export default {
  ...
  methods: {
    changeActive11() {
      this.changeActive1 = true
      this.changeActive2 = false
      this.changeActive3 = false
    },
    changeActive22() {
      this.changeActive2 = true
      this.changeActive1 = false
      this.changeActive3 = false
    },
    changeActive33() {
      this.changeActive3 = true
      this.changeActive1 = false
      this.changeActive2 = false
    },
    //表单元素修改产品个数
