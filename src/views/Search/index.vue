      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <!-- 品牌的面包屑 -->
            <li class="with-x" v-if="searchParams.trademark">{{ searchParams.trademark.split(':')[1] }}<i @click="removeTrakemark">×</i></li>
            <!-- 平台的售卖的属性值展示 -->
            <li class="with-x" v-for="(attrValue, index) in searchParams.props" @click="removeAttr(index)">{{ attrValue.split(':')[1] }}<i @click="removeTrakemark">×</i></li>
          </ul>
        </div>
        ...
        <div class="details clearfix">
          ...
          <!-- 分页器 -->
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5" @getPageNo="getPageNoBa"></Pagination>
        </div>
      </div>
    </div>
  </div>
